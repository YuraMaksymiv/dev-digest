...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Layer placement + dependency direction in `server/`; enforced by `pnpm --dir server arch` |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | Where code goes in `client/`: component placement, splitting, constants/helpers, business-logic layering |

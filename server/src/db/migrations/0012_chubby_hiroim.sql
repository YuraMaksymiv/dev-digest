...
CREATE INDEX "conventions_repo_created_idx" ON "conventions" USING btree ("repo_id","created_at");--> statement-breakpoint
ALTER TABLE "conventions" ADD CONSTRAINT "conventions_category_ck" CHECK ("conventions"."category" in ('naming', 'structure', 'error_handling', 'async', 'typing', 'testing', 'imports', 'api'));--> statement-breakpoint
